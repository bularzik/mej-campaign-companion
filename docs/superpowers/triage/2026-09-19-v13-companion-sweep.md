...
| 2026-09-20 | Foundry 13 full suite after the ready-wiring change | 13.351 | stock 13.06 | world-b | 133 passed, 5 failed, 23 skipped — `10-secrets-hub:167` (mej-13.06) and `09-secrets` (baseline) as attributed; `02-hub-timeline:155/:215/:288` environmental: a stray empty "Campaign Timeline" world timeline present in world-b (origin not established; possibly regenerated by this task's repeated stock-gate invocations), not a code regression |
...
2. **Native mode wires itself after `game.ready`, and the gap is user-visible — closed 2026-09-20.**
   ...
   Spec §5's recorded target of under 100 ms from the ready hook to the shim
   was not met (161–209 ms); the gate makes that number moot for companion
   documents.
